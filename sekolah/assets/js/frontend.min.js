...
c.parentNode?c.parentNode.disabled===a:c.disabled===a:c.isDisabled===a||c.isDisabled!==!a&&wa(c)===a:c.disabled===a:"label"in c?c.disabled===a:!1}}function l(a){return d(function(c){c=+c;return d(function(e,d){for(var h,m=a([],e.length,c),y=m.length;y--;)e[h=m[y]]&&(e[h]=!(d[h]=e[h]))})})}function q(a){return a&&"undefined"!==typeof a.getElementsByTagName&&a}function f(){}function A(a){for(var c=0,e=a.length,d="";c<e;c++)d+=a[c].value;return d}function z(a,c,e){var d=c.dir,h=c.next,m=h||d,y=e&&"parentNode"===
m,t=X++;return c.first?function(c,e,h){for(;c=c[d];)if(1===c.nodeType||y)return a(c,e,h);return!1}:function(c,e,x){var k,l=[S,t];if(x)for(;c=c[d];){if((1===c.nodeType||y)&&a(c,e,x))return!0}else for(;c=c[d];)if(1===c.nodeType||y){var q=c[J]||(c[J]={});q=q[c.uniqueID]||(q[c.uniqueID]={});if(h&&h===c.nodeName.toLowerCase())c=c[d]||c;else{if((k=q[m])&&k[0]===S&&k[1]===t)return l[2]=k[2];q[m]=l;if(l[2]=a(c,e,x))return!0}}return!1}}function n(a){return 1<a.length?function(c,e,d){for(var h=a.length;h--;)if(!a[h](c,
e,d))return!1;return!0}:a[0]}function u(a,c,e,d,h){for(var m,y=[],t=0,x=a.length,k=null!=c;t<x;t++)if(m=a[t])if(!e||e(m,d,h))y.push(m),k&&c.push(t);return y}function p(a,e,h,m,y,t){m&&!m[J]&&(m=p(m));y&&!y[J]&&(y=p(y,t));return d(function(d,t,x,k){var l,q=[],f=[],A=t.length,z;if(!(z=d)){z=e||"*";for(var n=x.nodeType?[x]:x,Z=[],p=0,Ca=n.length;p<Ca;p++)c(z,n[p],Z);z=Z}z=!a||!d&&e?z:u(z,q,a,x,k);n=h?y||(d?a:A||m)?[]:t:z;h&&h(z,n,x,k);if(m){var K=u(n,f);m(K,[],x,k);for(x=K.length;x--;)if(l=K[x])n[f[x]]=
!(z[f[x]]=l)}if(d){if(y||a){if(y){K=[];for(x=n.length;x--;)(l=n[x])&&K.push(z[x]=l);y(null,n=[],K,k)}for(x=n.length;x--;)(l=n[x])&&-1<(K=y?ca(d,l):q[x])&&(d[K]=!(t[K]=l))}}else n=u(n===t?n.splice(A,n.length):n),y?y(null,t,n,k):ba.apply(t,n)})}function K(a){var c,e,d=a.length,h=Q.relative[a[0].type];var m=h||Q.relative[" "];for(var y=h?1:0,t=z(function(a){return a===c},m,!0),x=z(function(a){return-1<ca(c,a)},m,!0),k=[function(a,e,d){a=!h&&(d||e!==F)||((c=e).nodeType?t(a,e,d):x(a,e,d));c=null;return a}];y<
d;y++)if(m=Q.relative[a[y].type])k=[z(n(k),m)];else{m=Q.filter[a[y].type].apply(null,a[y].matches);if(m[J]){for(e=++y;e<d&&!Q.relative[a[e].type];e++);return p(1<y&&n(k),1<y&&A(a.slice(0,y-1).concat({value:" "===a[y-2].type?"*":""})).replace(ga,"$1"),m,y<e&&K(a.slice(y,e)),e<d&&K(a=a.slice(e)),e<d&&A(a))}k.push(m)}return n(k)}function w(a,e){var h=0<e.length,m=0<a.length,y=function(d,y,t,x,k){var l,q,f=0,A="0",n=d&&[],z=[],Z=F,p=d||m&&Q.find.TAG("*",k),Ca=S+=null==Z?1:Math.random()||.1,K=p.length;
for(k&&(F=y===M||y||k);A!==K&&null!=(l=p[A]);A++){if(m&&l){var Ma=0;y||l.ownerDocument===M||(za(l),t=!C);for(;q=a[Ma++];)if(q(l,y||M,t)){x.push(l);break}k&&(S=Ca)}h&&((l=!q&&l)&&f--,d&&n.push(l))}f+=A;if(h&&A!==f){for(Ma=0;q=e[Ma++];)q(n,z,y,t);if(d){if(0<f)for(;A--;)n[A]||z[A]||(z[A]=P.call(x));z=u(z)}ba.apply(x,z);k&&!d&&0<z.length&&1<f+e.length&&c.uniqueSort(x)}k&&(S=Ca,F=Z);return n};return h?d(y):y}var L,F,v,N,M,B,C,D,I,E,G,J="sizzle"+1*new Date,T=a.document,S=0,X=0,ha=e(),U=e(),Y=e(),W=function(a,
...
function(c,e,x){var k,l;e=m!==y?"nextSibling":"previousSibling";var q=c.parentNode,f=t&&c.nodeName.toLowerCase();x=!x&&!t;var A=!1;if(q){if(m){for(;e;){for(k=c;k=k[e];)if(t?k.nodeName.toLowerCase()===f:1===k.nodeType)return!1;var z=e="only"===a&&!z&&"nextSibling"}return!0}z=[y?q.firstChild:q.lastChild];if(y&&x){k=q;var n=k[J]||(k[J]={});n=n[k.uniqueID]||(n[k.uniqueID]={});A=n[a]||[];A=(l=A[0]===S&&A[1])&&A[2];for(k=l&&q.childNodes[l];k=++l&&k&&k[e]||(A=l=0)||z.pop();)if(1===k.nodeType&&++A&&k===c){n[a]=
[S,l,A];break}}else if(x&&(k=c,n=k[J]||(k[J]={}),n=n[k.uniqueID]||(n[k.uniqueID]={}),A=n[a]||[],A=l=A[0]===S&&A[1]),!1===A)for(;(k=++l&&k&&k[e]||(A=l=0)||z.pop())&&((t?k.nodeName.toLowerCase()!==f:1!==k.nodeType)||!++A||(x&&(n=k[J]||(k[J]={}),n=n[k.uniqueID]||(n[k.uniqueID]={}),n[a]=[S,A]),k!==c)););A-=h;return A===d||0===A%d&&0<=A/d}}},PSEUDO:function(a,e){var h=Q.pseudos[a]||Q.setFilters[a.toLowerCase()]||c.error("unsupported pseudo: "+a);if(h[J])return h(e);if(1<h.length){var m=[a,a,"",e];return Q.setFilters.hasOwnProperty(a.toLowerCase())?
...
var da=/[^\x20\t\r\n\f]+/g;p.Callbacks=function(a){a="string"===typeof a?h(a):p.extend({},a);var c,e,d,m,y=[],t=[],x=-1,k=function(){m=m||a.once;for(d=c=!0;t.length;x=-1)for(e=t.shift();++x<y.length;)!1===y[x].apply(e[0],e[1])&&a.stopOnFalse&&(x=y.length,e=!1);a.memory||(e=!1);c=!1;m&&(y=e?[]:"")},l={add:function(){y&&(e&&!c&&(x=y.length-1,t.push(e)),function yb(c){p.each(c,function(c,e){p.isFunction(e)?a.unique&&l.has(e)||y.push(e):e&&e.length&&"string"!==p.type(e)&&yb(e)})}(arguments),e&&!c&&k());
...
p.event={global:{},add:function(a,c,e,d,h){var m,t,x,k,y;if(x=O.get(a)){if(e.handler){var l=e;e=l.handler;h=l.selector}h&&p.find.matchesSelector(La,h);e.guid||(e.guid=p.guid++);(t=x.events)||(t=x.events={});(m=x.handle)||(m=x.handle=function(c){return"undefined"!==typeof p&&p.event.triggered!==c.type?p.event.dispatch.apply(a,arguments):void 0});c=(c||"").match(da)||[""];for(x=c.length;x--;){var q=lb.exec(c[x])||[];var f=k=q[1];var A=(q[2]||"").split(".").sort();f&&(q=p.event.special[f]||{},f=(h?q.delegateType:
q.bindType)||f,q=p.event.special[f]||{},k=p.extend({type:f,origType:k,data:d,handler:e,guid:e.guid,selector:h,needsContext:h&&p.expr.match.needsContext.test(h),namespace:A.join(".")},l),(y=t[f])||(y=t[f]=[],y.delegateCount=0,q.setup&&!1!==q.setup.call(a,d,A,m)||a.addEventListener&&a.addEventListener(f,m)),q.add&&(q.add.call(a,k),k.handler.guid||(k.handler.guid=e.guid)),h?y.splice(y.delegateCount++,0,k):y.push(k),p.event.global[f]=!0)}}},remove:function(a,c,e,d,h){var m,t,x,k,y,l=O.hasData(a)&&O.get(a);
if(l&&(x=l.events)){c=(c||"").match(da)||[""];for(k=c.length;k--;){var q=lb.exec(c[k])||[];var f=y=q[1];var A=(q[2]||"").split(".").sort();if(f){var n=p.event.special[f]||{};f=(d?n.delegateType:n.bindType)||f;var z=x[f]||[];q=q[2]&&new RegExp("(^|\\.)"+A.join("\\.(?:.*\\.|)")+"(\\.|$)");for(t=m=z.length;m--;){var u=z[m];!h&&y!==u.origType||e&&e.guid!==u.guid||q&&!q.test(u.namespace)||d&&d!==u.selector&&("**"!==d||!u.selector)||(z.splice(m,1),u.selector&&z.delegateCount--,n.remove&&n.remove.call(a,
u))}t&&!z.length&&(n.teardown&&!1!==n.teardown.call(a,A,l.handle)||p.removeEvent(a,f,l.handle),delete x[f])}else for(f in x)p.event.remove(a,f+c[k],e,d,!0)}p.isEmptyObject(x)&&O.remove(a,"handle events")}},dispatch:function(a){var c=p.event.fix(a),e,d,h,m=Array(arguments.length);var t=(O.get(this,"events")||{})[c.type]||[];var x=p.event.special[c.type]||{};m[0]=c;for(e=1;e<arguments.length;e++)m[e]=arguments[e];c.delegateTarget=this;if(!x.preDispatch||!1!==x.preDispatch.call(this,c)){var k=p.event.handlers.call(this,
...
a);if(!(R.noCloneChecked||1!==a.nodeType&&11!==a.nodeType||p.isXMLDoc(a))){var x=t(h);var k=t(a);var l=0;for(d=k.length;l<d;l++){var q=k[l],y=x[l],f=y.nodeName.toLowerCase();if("input"===f&&Sa.test(q.type))y.checked=q.checked;else if("input"===f||"textarea"===f)y.defaultValue=q.defaultValue}}if(c)if(e)for(k=k||t(a),x=x||t(h),l=0,d=k.length;l<d;l++)D(k[l],x[l]);else D(a,h);x=t(h,"script");0<x.length&&A(x,!m&&t(a,"script"));return h},cleanData:function(a){for(var c,e,d,h=p.event.special,m=0;void 0!==
...
ha.tweeners[e]||[],ha.tweeners[e].unshift(c)},prefilters:[function(a,c,e){var d;var h="width"in c||"height"in c;var m=this,t={},x=a.style,k=a.nodeType&&Ea(a),l=O.get(a,"fxshow");if(!e.queue){var q=p._queueHooks(a,"fx");if(null==q.unqueued){q.unqueued=0;var f=q.empty.fire;q.empty.fire=function(){q.unqueued||f()}}q.unqueued++;m.always(function(){m.always(function(){q.unqueued--;p.queue(a,"fx").length||q.empty.fire()})})}for(d in c){var A=c[d];if(Wb.test(A)){delete c[d];var n=n||"toggle"===A;if(A===
(k?"hide":"show"))if("show"===A&&l&&void 0!==l[d])k=!0;else continue;t[d]=l&&l[d]||p.style(a,d)}}if((c=!p.isEmptyObject(c))||!p.isEmptyObject(t)){if(h&&1===a.nodeType){e.overflow=[x.overflow,x.overflowX,x.overflowY];var y=l&&l.display;null==y&&(y=O.get(a,"display"));h=p.css(a,"display");"none"===h&&(y?h=y:(z([a],!0),y=a.style.display||y,h=p.css(a,"display"),z([a])));("inline"===h||"inline-block"===h&&null!=y)&&"none"===p.css(a,"float")&&(c||(m.done(function(){x.display=y}),null==y&&(h=x.display,y=
"none"===h?"":h)),x.display="inline-block")}e.overflow&&(x.overflow="hidden",m.always(function(){x.overflow=e.overflow[0];x.overflowX=e.overflow[1];x.overflowY=e.overflow[2]}));c=!1;for(d in t)c||(l?"hidden"in l&&(k=l.hidden):l=O.access(a,"fxshow",{display:y}),n&&(l.hidden=!k),k&&z([a],!0),m.done(function(){k||z([a]);O.remove(a,"fxshow");for(d in t)p.style(a,d,t[d])})),c=ra(k?l[d]:0,d,m),d in l||(l[d]=c.start,k&&(c.end=c.start,c.start=0))}}],prefilter:function(a,c){c?ha.prefilters.unshift(a):ha.prefilters.push(a)}});
...
l.proxy(function(){this.$element.trigger("loaded.bs.modal")},this))};v.VERSION="3.3.7";v.TRANSITION_DURATION=300;v.BACKDROP_TRANSITION_DURATION=150;v.DEFAULTS={backdrop:!0,keyboard:!0,show:!0};v.prototype.toggle=function(l){return this.isShown?this.hide():this.show(l)};v.prototype.show=function(f){var n=this,k=l.Event("show.bs.modal",{relatedTarget:f});this.$element.trigger(k);this.isShown||k.isDefaultPrevented()||(this.isShown=!0,this.checkScrollbar(),this.setScrollbar(),this.$body.addClass("modal-open"),
...
v.prototype.handleUpdate=function(){this.adjustDialog()};v.prototype.adjustDialog=function(){var l=this.$element[0].scrollHeight>document.documentElement.clientHeight;this.$element.css({paddingLeft:!this.bodyIsOverflowing&&l?this.scrollbarWidth:"",paddingRight:this.bodyIsOverflowing&&!l?this.scrollbarWidth:""})};v.prototype.resetAdjustments=function(){this.$element.css({paddingLeft:"",paddingRight:""})};v.prototype.checkScrollbar=function(){var l=window.innerWidth;l||(l=document.documentElement.getBoundingClientRect(),
l=l.right-Math.abs(l.left));this.bodyIsOverflowing=document.body.clientWidth<l;this.scrollbarWidth=this.measureScrollbar()};v.prototype.setScrollbar=function(){var l=parseInt(this.$body.css("padding-right")||0,10);this.originalBodyPad=document.body.style.paddingRight||"";this.bodyIsOverflowing&&this.$body.css("padding-right",l+this.scrollbarWidth)};v.prototype.resetScrollbar=function(){this.$body.css("padding-right",this.originalBodyPad)};v.prototype.measureScrollbar=function(){var l=document.createElement("div");
l.className="modal-scrollbar-measure";this.$body.append(l);var f=l.offsetWidth-l.clientWidth;this.$body[0].removeChild(l);return f};var w=l.fn.modal;l.fn.modal=f;l.fn.modal.Constructor=v;l.fn.modal.noConflict=function(){l.fn.modal=w;return this};l(document).on("click.bs.modal.data-api",'[data-toggle="modal"]',function(u){var n=l(this),k=n.attr("href"),h=l(n.attr("data-target")||k&&k.replace(/.*(?=#[^\s]+$)/,"")),k=h.data("bs.modal")?"toggle":l.extend({remote:!/#/.test(k)&&k},h.data(),n.data());n.is("a")&&
...
10);isNaN(c)&&(c=0);isNaN(d)&&(d=0);f.top+=c;f.left+=d;l.offset.setOffset(n[0],l.extend({using:function(a){n.css({top:Math.round(a.top),left:Math.round(a.left)})}},f),0);n.addClass("in");var d=n[0].offsetWidth,a=n[0].offsetHeight;"top"==u&&a!=h&&(f.top=f.top+h-a);var e=this.getViewportAdjustedDelta(u,f,d,a);e.left?f.left+=e.left:f.top+=e.top;k=(c=/top|bottom/.test(u))?2*e.left-k+d:2*e.top-h+a;h=c?"offsetWidth":"offsetHeight";n.offset(f);this.replaceArrow(k,n[0][h],c)};f.prototype.replaceArrow=function(l,
f,n){this.arrow().css(n?"left":"top",50*(1-l/f)+"%").css(n?"top":"left","")};f.prototype.setContent=function(){var l=this.tip(),f=this.getTitle();l.find(".tooltip-inner")[this.options.html?"html":"text"](f);l.removeClass("fade in top bottom left right")};f.prototype.hide=function(v){function u(){"in"!=n.hoverState&&k.detach();n.$element&&n.$element.removeAttr("aria-describedby").trigger("hidden.bs."+n.type);v&&v()}var n=this,k=l(this.$tip),h=l.Event("hide.bs."+this.type);this.$element.trigger(h);
if(!h.isDefaultPrevented())return k.removeClass("in"),l.support.transition&&k.hasClass("fade")?k.one("bsTransitionEnd",u).emulateTransitionEnd(f.TRANSITION_DURATION):u(),this.hoverState=null,this};f.prototype.fixTitle=function(){var l=this.$element;(l.attr("title")||"string"!=typeof l.attr("data-original-title"))&&l.attr("data-original-title",l.attr("title")||"").attr("title","")};f.prototype.hasContent=function(){return this.getTitle()};f.prototype.getPosition=function(f){f=f||this.$element;var u=
f[0],n="BODY"==u.tagName,k=u.getBoundingClientRect();null==k.width&&(k=l.extend({},k,{width:k.right-k.left,height:k.bottom-k.top}));u=window.SVGElement&&u instanceof window.SVGElement;u=n?{top:0,left:0}:u?null:f.offset();f={scroll:n?document.documentElement.scrollTop||document.body.scrollTop:f.scrollTop()};n=n?{width:l(window).width(),height:l(window).height()}:null;return l.extend({},k,f,n,u)};f.prototype.getCalculatedOffset=function(l,f,n,k){return"bottom"==l?{top:f.top+f.height,left:f.left+f.width/
2-n/2}:"top"==l?{top:f.top-k,left:f.left+f.width/2-n/2}:"left"==l?{top:f.top+f.height/2-k/2,left:f.left-n}:{top:f.top+f.height/2-k/2,left:f.left+f.width}};f.prototype.getViewportAdjustedDelta=function(f,l,n,k){var h={top:0,left:0};if(!this.$viewport)return h;var c=this.options.viewport&&this.options.viewport.padding||0,d=this.getPosition(this.$viewport);/right|left/.test(f)?(n=l.top-c-d.scroll,l=l.top+c-d.scroll+k,n<d.top?h.top=d.top-n:l>d.top+d.height&&(h.top=d.top+d.height-l)):(k=l.left-c,l=l.left+
c+n,k<d.left?h.left=d.left-k:l>d.right&&(h.left=d.left+d.width-l));return h};f.prototype.getTitle=function(){var f=this.$element,l=this.options;return f.attr("data-original-title")||("function"==typeof l.title?l.title.call(f[0]):l.title)};f.prototype.getUID=function(l){do l+=~~(1E6*Math.random());while(document.getElementById(l));return l};f.prototype.tip=function(){if(!this.$tip&&(this.$tip=l(this.options.template),1!=this.$tip.length))throw Error(this.type+" `template` option must consist of exactly 1 top-level element!");
...
this.component.parent().offset():this.element.offset(),x=this.component?this.component.outerHeight(!0):this.element.outerHeight(!1),q=this.component?this.component.outerWidth(!0):this.element.outerWidth(!1),z=k.left-m.left,m=k.top-m.top;"body"!==this.o.container&&(m+=h);this.picker.removeClass("datepicker-orient-top datepicker-orient-bottom datepicker-orient-right datepicker-orient-left");"auto"!==this.o.orientation.x?(this.picker.addClass("datepicker-orient-"+this.o.orientation.x),"right"===this.o.orientation.x&&
(z-=a-q)):0>k.left?(this.picker.addClass("datepicker-orient-left"),z-=k.left-10):z+a>d?(this.picker.addClass("datepicker-orient-right"),z+=q-a):this.picker.addClass("datepicker-orient-left");a=this.o.orientation.y;"auto"===a&&(a=0>-h+m-c?"bottom":"top");this.picker.addClass("datepicker-orient-"+a);m="top"===a?m-(c+parseInt(this.picker.css("padding-top"))):m+x;this.o.rtl?this.picker.css({top:m,right:d-(z+q),zIndex:e}):this.picker.css({top:m,left:z,zIndex:e});return this},_allow_update:!0,update:function(){if(!this._allow_update)return this;
...
0,0],x=1,q=c.match(/^#([a-fA-F0-9]{3})$/);if(q)for(q=q[1],c=0;c<k.length;c++)k[c]=parseInt(q[c]+q[c],16);else if(q=c.match(e))for(q=q[1],c=0;c<k.length;c++)k[c]=parseInt(q.slice(2*c,2*c+2),16);else if(q=c.match(d)){for(c=0;c<k.length;c++)k[c]=parseInt(q[c+1]);x=parseFloat(q[4])}else if(q=c.match(h)){for(c=0;c<k.length;c++)k[c]=Math.round(2.55*parseFloat(q[c+1]));x=parseFloat(q[4])}else if(q=c.match(f)){if("transparent"==q[1])return[0,0,0,0];k=m[q[1]];if(!k)return}for(c=0;c<k.length;c++)k[c]=a(k[c],
0,255);x=x||0==x?a(x,0,1):1;k[3]=x;return k}}function n(c){if(c){var e=c.match(/^hsla?\(\s*([+-]?\d+)(?:deg)?\s*,\s*([+-]?[\d\.]+)%\s*,\s*([+-]?[\d\.]+)%\s*(?:,\s*([+-]?[\d\.]+)\s*)?\)/);if(e){var d=parseFloat(e[4]);c=a(parseInt(e[1]),0,360);var h=a(parseFloat(e[2]),0,100),e=a(parseFloat(e[3]),0,100),d=a(isNaN(d)?1:d,0,1);return[c,h,e,d]}}}function k(c){if(c){var e=c.match(/^hwb\(\s*([+-]?\d+)(?:deg)?\s*,\s*([+-]?[\d\.]+)%\s*,\s*([+-]?[\d\.]+)%\s*(?:,\s*([+-]?[\d\.]+)\s*)?\)/);if(e){var d=parseFloat(e[4]);
...
footerSpacing:a.footerSpacing,footerMarginTop:a.footerMarginTop,caretSize:a.caretSize,cornerRadius:a.cornerRadius,backgroundColor:a.backgroundColor,opacity:0,legendColorBackground:a.multiKeyBackground,displayColors:a.displayColors}}function d(a,c){var d=a._chart.ctx,e=2*c.yPadding,h=0,f=c.body,k=f.reduce(function(a,c){return a+c.before.length+c.lines.length+c.after.length},0),k=k+(c.beforeBody.length+c.afterBody.length),n=c.title.length,q=c.footer.length,x=c.titleFontSize,u=c.bodyFontSize,v=c.footerFontSize,
e=e+n*x+(n?(n-1)*c.titleSpacing:0),e=e+(n?c.titleMarginBottom:0),e=e+k*u+(k?(k-1)*c.bodySpacing:0),e=e+(q?c.footerMarginTop:0),e=e+q*v,e=e+(q?(q-1)*c.footerSpacing:0),w=0,D=function(a){h=Math.max(h,d.measureText(a).width+w)};d.font=m.fontString(x,c._titleFontStyle,c._titleFontFamily);m.each(c.title,D);d.font=m.fontString(u,c._bodyFontStyle,c._bodyFontFamily);m.each(c.beforeBody.concat(c.afterBody),D);w=c.displayColors?u+2:0;m.each(f,function(a){m.each(a.before,D);m.each(a.lines,D);m.each(a.after,
...
c.base;var e=c.x;var f=c.y-c.height/2;var k=c.y+c.height/2;var n=e>a?1:-1;var u=1;var t=c.borderSkipped||"left"}else a=c.x-c.width/2,e=c.x+c.width/2,f=c.y,k=c.base,n=1,u=k>f?1:-1,t=c.borderSkipped||"bottom";if(d){var v=Math.min(Math.abs(a-e),Math.abs(f-k)),d=d>v?v:d,w=d/2,v=a+("left"!==t?w*n:0);n=e+("right"!==t?-w*n:0);var N=f+("top"!==t?w*u:0);u=k+("bottom"!==t?-w*u:0);v!==n&&(f=N,k=u);N!==u&&(a=v,e=n)}h.beginPath();h.fillStyle=c.backgroundColor;h.strokeStyle=c.borderColor;h.lineWidth=d;c=[[a,k],
[a,f],[e,f],[e,k]];t=["bottom","left","top","right"].indexOf(t,0);-1===t&&(t=0);a=c[(t+0)%4];h.moveTo(a[0],a[1]);for(e=1;4>e;e++)a=c[(t+e)%4],h.lineTo(a[0],a[1]);h.fill();d&&h.stroke()},height:function(){var h=this._view;return h.base-h.y},inRange:function(h,c){var d=!1;this._view&&(d=n(this),d=h>=d.left&&h<=d.right&&c>=d.top&&c<=d.bottom);return d},inLabelRange:function(h,c){if(!this._view)return!1;var d=n(this);return void 0!==this._view.width?h>=d.left&&h<=d.right:c>=d.top&&c<=d.bottom},inXRange:function(h){var c=
n(this);return h>=c.left&&h<=c.right},inYRange:function(h){var c=n(this);return h>=c.top&&h<=c.bottom},getCenterPoint:function(){var h=this._view;if(void 0!==this._view.width){var c=h.x;h=(h.y+h.base)/2}else c=(h.x+h.base)/2,h=h.y;return{x:c,y:h}},getArea:function(){var h=this._view;return h.width*Math.abs(h.y-h.base)},tooltipPosition:function(){var h=this._view;return{x:h.x,y:h.y}}})}},{}],41:[function(f,v,w){v.exports=function(f){function n(a,c){var e=d.getStyle(a,c);return(e=e&&e.match(/(\d+)px/))?
...
c)+this.yCenter}},getPointPositionForValue:function(a,c){return this.getPointPosition(a,this.getDistanceFromCenterForValue(c))},getBasePosition:function(){var a=this.min,c=this.max;return this.getPointPositionForValue(0,this.beginAtZero?0:0>a&&0>c?c:0<a&&0<c?a:0)},draw:function(){var d=this,f=d.options,h=f.gridLines,k=f.ticks,m=a.getValueOrDefault;if(f.display){var u=d.ctx,v=m(k.fontSize,e.defaultFontSize),x=m(k.fontStyle,e.defaultFontStyle),w=m(k.fontFamily,e.defaultFontFamily),E=a.fontString(v,
x,w);a.each(d.ticks,function(c,q){if(0<q||f.reverse){var t=d.getDistanceFromCenterForValue(d.ticksAsNumbers[q]),x=d.yCenter-t;if(h.display&&0!==q)a:{var w=d.ctx;w.strokeStyle=a.getValueAtIndexOrDefault(h.color,q-1);w.lineWidth=a.getValueAtIndexOrDefault(h.lineWidth,q-1);if(d.options.lineArc)w.beginPath(),w.arc(d.xCenter,d.yCenter,t,0,2*Math.PI);else{var z=n(d);if(0===z)break a;w.beginPath();var A=d.getPointPosition(0,t);w.moveTo(A.x,A.y);for(var B=1;B<z;B++)A=d.getPointPosition(B,t),w.lineTo(A.x,
...
$("#mobile_phone").length&&l.append("mobile_phone",$("#mobile_phone").val());$("#email").length&&l.append("email",$("#email").val());$("#sktm").length&&l.append("sktm",$("#sktm").val());$("#kks").length&&l.append("kks",$("#kks").val());$("#kps").length&&l.append("kps",$("#kps").val());$("#kip").length&&l.append("kip",$("#kip").val());$("#kis").length&&l.append("kis",$("#kis").val());$("#citizenship").length&&l.append("citizenship",$("#citizenship").val());$("#country").length&&l.append("country",
$("#country").val());$("#father_name").length&&l.append("father_name",$("#father_name").val());$("#father_birth_year").length&&l.append("father_birth_year",$("#father_birth_year").val());$("#father_education").length&&l.append("father_education",$("#father_education").val());$("#father_employment").length&&l.append("father_employment",$("#father_employment").val());$("#father_monthly_income").length&&l.append("father_monthly_income",$("#father_monthly_income").val());$("#father_special_needs").length&&
l.append("father_special_needs",$("#father_special_needs").val());$("#mother_name").length&&l.append("mother_name",$("#mother_name").val());$("#mother_birth_year").length&&l.append("mother_birth_year",$("#mother_birth_year").val());$("#mother_education").length&&l.append("mother_education",$("#mother_education").val());$("#mother_employment").length&&l.append("mother_employment",$("#mother_employment").val());$("#mother_monthly_income").length&&l.append("mother_monthly_income",$("#mother_monthly_income").val());
$("#mother_special_needs").length&&l.append("mother_special_needs",$("#mother_special_needs").val());$("#guardian_name").length&&l.append("guardian_name",$("#guardian_name").val());$("#guardian_birth_year").length&&l.append("guardian_birth_year",$("#guardian_birth_year").val());$("#guardian_education").length&&l.append("guardian_education",$("#guardian_education").val());$("#guardian_employment").length&&l.append("guardian_employment",$("#guardian_employment").val());$("#guardian_monthly_income").length&&
l.append("guardian_monthly_income",$("#guardian_monthly_income").val());$("#mileage").length&&l.append("mileage",$("#mileage").val());$("#traveling_time").length&&l.append("traveling_time",$("#traveling_time").val());$("#height").length&&l.append("height",$("#height").val());$("#weight").length&&l.append("weight",$("#weight").val());$("#sibling_number").length&&l.append("sibling_number",$("#sibling_number").val());l.append("captcha",$("#captcha").val());l.append("declaration",$("#declaration").prop("checked"));
l.append("csrf_token",$('meta[name="csrf-token"]').attr("content"));$.ajax({url:_BASE_URL+"public/admission_form/save",type:"POST",data:l,contentType:!1,processData:!1,success:function(f){f=H.stringToJSON(f);"token_error"==f.type?window.location.reload(!0):(H.growl(f.type,f.message),$('meta[name="csrf-token"]').attr("content",f.csrf_token),"success"==f.type&&window.open(_BASE_URL+"media_library/students/"+f.file_name,"_self"))}})}
