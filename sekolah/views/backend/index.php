...
<head>
	...
	<script type="text/javascript" src="<?=base_url('assets/js/eModal.js')?>"></script>
	...
	<script type="text/javascript" src="<?=base_url('assets/js/jquery-clockpicker.js')?>"></script>
	...
	<script type="text/javascript" src="<?=base_url('assets/js/jquery.tagsinput.js')?>"></script>
	<script type="text/javascript" src="<?=base_url('assets/js/data_sources.js')?>"></script>
	<script type="text/javascript" src="<?=base_url('assets/js/markup-html.js')?>"></script>
	<script type="text/javascript" src="<?=base_url('assets/js/global.js')?>"></script>
	<script type="text/javascript" src="<?=base_url('assets/js/backend.js')?>"></script>
	<script type="text/javascript" src="<?=base_url('assets/js/grid_builder.js')?>"></script>
